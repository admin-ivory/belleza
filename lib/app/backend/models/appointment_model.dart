...
class AppointmentModel {
  ...
  AppointmentModel.fromJson(Map<String, dynamic> json) {
    ...
    if (json.containsKey('ownerInfo')) {
      ownerInfo = json['ownerInfo'] != null ? OwnerInfoModel.fromJson(json['ownerInfo']) : null;
    }
    if (json.containsKey('specialistInfo')) {
      specialistInfo = json['specialistInfo'] != null ? SpecialistInfo.fromJson(json['specialistInfo']) : null;
    }
  }
  ...
  Map<String, dynamic> toJson() {
    ...
    if (specialistInfo != null) {
      data['specialistInfo'] = specialistInfo!.toJson();
    }
    return data;
  }
}
...
class OwnerInfoModel {
  ...
  OwnerInfoModel({this.firstName, this.lastName, this.email, this.mobile, this.countryCode, this.fcmToken, this.cover});
...
class SpecialistInfo {
  ...
  SpecialistInfo({this.id, this.firstName, this.lastName, this.cover});

  SpecialistInfo.fromJson(Map<String, dynamic> json) {
