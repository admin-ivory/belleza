...
class AppConstants {
  ...
  static const String defaultCurrencyCode = 'EUR'; // your currency code in 3 digit
  ...
  static const String defaultLanguageApp = 'fr';
  ...
  static const String getDataFromCategories = 'api/v1/salon/getDataFromCategory';
  ...
  static const String getServicesById = 'api/v1/freelancer_services/getByCategoryId';
  ...
  static const String stripeWebCheckoutLink = 'api/v1/payments/stripeAppCheckout?amount=';
  ...
  static const String sendNotification = 'api/v1/notification/sendNotificationUID';
  ...
  static const String getProductsReview = 'api/v1/products_reviews/getProductsReviews';
