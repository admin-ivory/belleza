...
// import 'package:hair_salon_app/core/app_export.dart';
//
...
//               Colors.grey[300],
//             border: Border.all(
//                       color: ColorConstant.pink800, width: 1),
...
//                 crossAxisSpacing: getVerticalSize(24),
//                 mainAxisExtent: getVerticalSize(34)),
//             itemBuilder: (context, index) {
//               return _buildButton(index, widget.tabs[index] as Tab);
//             },
//           ),
//         ),
//       ),
      ...
      child: AnimatedBuilder(
        ...
        builder: (context, child) => SizedBox(
          ...
          child: GridView.builder(
            ...
            gridDelegate: SliverGridDelegateWithFixedCrossAxisCount(
                crossAxisCount:  widget.tabs.length ,
                crossAxisSpacing: getVerticalSize(widget.space),
                mainAxisExtent: getVerticalSize(34)),
            itemBuilder: (context, index) {
              return _buildButton(index, widget.tabs[index] as Tab);
            },
