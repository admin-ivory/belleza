...
class AppointmentDetailController extends GetxController implements GetxService {
  ...
  Future<void> getAppointmentDetails() async {
    ...
    if (response.statusCode == 200) {
      ...
      notes = _appointmentInfo.notes!.toString();
      try {
        if (_appointmentInfo.specialistId! != 0 && _appointmentInfo.specialistInfo!.firstName!.isNotEmpty) {
          specialistName = '${_appointmentInfo.specialistInfo!.firstName} ${_appointmentInfo.specialistInfo!.lastName!}';
          specialistCover = _appointmentInfo.specialistInfo!.cover!;
          haveSpecialist = true;
        }
      } catch (e) {
        haveSpecialist = false;
        debugPrint('e -->');
      }
      debugPrint('Notes --> $notes');
      debugPrint('specialistName --> $specialistName');
      debugPrint('specialistCover --> $specialistCover');
      update();
    } else {
      ...
      builder: (context) {
        return AlertDialog(
          ...
          title: Row(
            ...
            children: [Text('Rate Your Appointment'.tr, style: const TextStyle(fontSize: 14, fontFamily: 'bold')), IconButton(onPressed: () => Get.back(), icon: const Icon(Icons.close, size: 14))],
          ),
          content: SizedBox(
            ...
            child: SingleChildScrollView(
              child: Column(
                ...
                children: [
                  Text('Owner'.tr, overflow: TextOverflow.ellipsis, style: const TextStyle(color: ThemeProvider.appColor, fontFamily: 'bold', fontSize: 15)),
                  Container(
                    ...
                    child: Row(
                      ...
                      children: <Widget>[
                        Text(
                          appointmentInfo.salonId != 0 ? appointmentInfo.salonInfo!.name.toString() : '${appointmentInfo.ownerInfo!.firstName!} ${appointmentInfo.ownerInfo!.lastName!}',
                        ...
                        InkWell(
                          onTap: () {
                            ...
                            Get.toNamed(
                              AppRouter.getAddReviewsRoutes(),
                              arguments: [
                                'owner',
                                appointmentInfo.salonId != 0 ? appointmentInfo.salonInfo!.cover.toString().toString() : appointmentInfo.ownerInfo!.cover.toString(),
                                appointmentInfo.salonId != 0 ? appointmentInfo.salonInfo!.name.toString() : '${appointmentInfo.ownerInfo!.firstName} ${appointmentInfo.ownerInfo!.lastName}',
                                appointmentInfo.salonId != 0 ? appointmentInfo.salonId.toString() : appointmentInfo.freelancerId.toString()
                              ],
                            );
                          },
                  ...
                  Column(
                    ...
                    mainAxisAlignment: MainAxisAlignment.start,
                    children: [
                      appointmentInfo.items!.services!.isNotEmpty ? const Text('Services', overflow: TextOverflow.ellipsis, style: TextStyle(color: ThemeProvider.appColor, fontFamily: 'bold', fontSize: 15)) : const SizedBox(),
                      const SizedBox(height: 10),
                      Column(
                        crossAxisAlignment: CrossAxisAlignment.start,
                        mainAxisAlignment: MainAxisAlignment.start,
                        children: List.generate(
                          ...
                          (serviceIndex) => Padding(
                            ...
                            child: Row(
                              ...
                              children: [
                                Text(
                                  appointmentInfo.items!.services![serviceIndex].name.toString(),
                                ...
                                InkWell(
                                  onTap: () {
                                    ...
                                    Get.toNamed(
                                      ...
                                      arguments: [
                                        'service',
                                        appointmentInfo.items!.services![serviceIndex].cover.toString(),
                                        appointmentInfo.items!.services![serviceIndex].name.toString(),
                                        appointmentInfo.items!.services![serviceIndex].id.toString(),
                                        appointmentInfo.salonId != 0 ? appointmentInfo.salonId.toString() : appointmentInfo.freelancerId.toString()
                                      ],
                                    );
                                  },
                      ...
                      const SizedBox(height: 10),
                      appointmentInfo.items!.packages!.isNotEmpty ? const Text('Packages', overflow: TextOverflow.ellipsis, style: TextStyle(color: ThemeProvider.appColor, fontFamily: 'bold', fontSize: 15)) : const SizedBox(),
                      Column(
                        crossAxisAlignment: CrossAxisAlignment.start,
                        mainAxisAlignment: MainAxisAlignment.start,
                        children: List.generate(
                            ...
                            child: Column(
                              ...
                              children: [
                                Row(
                                  ...
                                  children: [
                                    Text(
                                      appointmentInfo.items!.packages![packageIndex].name.toString(),
                                      overflow: TextOverflow.ellipsis,
                                      style: const TextStyle(fontFamily: 'regular', fontSize: 10, color: ThemeProvider.blackColor),
                                    ),
                                    InkWell(
                                      onTap: () {
                                        ...
                                        Get.toNamed(
                                          ...
                                          arguments: [
                                            'package',
                                            appointmentInfo.items!.packages![packageIndex].cover.toString(),
                                            appointmentInfo.items!.packages![packageIndex].name.toString(),
                                            appointmentInfo.items!.packages![packageIndex].id.toString(),
                                            appointmentInfo.salonId != 0 ? appointmentInfo.salonId.toString() : appointmentInfo.freelancerId.toString()
                                          ],
                                        );
                                      },
        ...
        actions: <CupertinoActionSheetAction>[
          CupertinoActionSheetAction(
            ...
            onPressed: () {
              ...
              Get.toNamed(AppRouter.getChatRoutes(), arguments: [parser.getAdminId().toString(), parser.getAdminName()]);
            },
          ),
          CupertinoActionSheetAction(
