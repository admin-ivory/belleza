...
import 'package:user/app/backend/models/issuewith_model.dart';
...
class ComplaintsController extends GetxController implements GetxService {
  ...
  Future<void> getAppointmentById() async {
    ...
    if (response.statusCode == 200) {
      ...
      if (_appointmentDetail.salonId != 0) {
        ...
        freelancerName = '${_appointmentDetail.individualInfo!.firstName} ${_appointmentDetail.individualInfo!.lastName}';
      }
  ...
  Future<void> getOrderDetails() async {
    ...
    if (response.statusCode == 200) {
      ...
      if (_details.type == 'salon') {
        ...
        freelancerName = '${_details.freelancerInfo!.firstName} ${_details.freelancerInfo!.lastName}';
      }
      debugPrint('freelancer id$freelancerID');
      debugPrint('freelancer name$freelancerName');
      _issueWithList = [];
  ...
  Future<void> onIssueModal() async {
    ...
    showDialog(
      ...
      builder: (BuildContext context) {
        return AlertDialog(
          scrollable: true,
          title: Text('Choose Issue With'.tr, style: const TextStyle(fontSize: 14, fontFamily: 'bold'), textAlign: TextAlign.center),
          content: Column(
            children: [
              SizedBox(
                      ...
                      return ListTile(
                        ...
                        leading: Radio(
                          ...
                          onChanged: (e) {
                            ...
                            var selected = issueWithList.firstWhere((element) => element.id.toString() == issueWith).name;
  ...
  Future<void> onReasonModal() async {
    ...
    showDialog(
      ...
      builder: (BuildContext context) {
        return AlertDialog(
          scrollable: true,
          title: Text('Choose Reason'.tr, style: const TextStyle(fontSize: 14, fontFamily: 'bold'), textAlign: TextAlign.center),
          content: Column(
            children: [
              SizedBox(
                height: 200.0, // Change as per your requirement
                      ...
                      : ListView.builder(
                          ...
                          itemBuilder: (BuildContext context, int index) {
                            ...
                            return ListTile(
                              textColor: ThemeProvider.appColor,
                              iconColor: ThemeProvider.appColor,
                              title: Text(freelancerReasonsList[index].toString()),
                              leading: Radio(
                                fillColor: WidgetStateProperty.resolveWith(getColor),
                                value: freelancerReasonsList[index].toString(),
                                groupValue: selectedReason,
                                onChanged: (e) {
                                  selectedReason = e.toString();
                                  update();
  ...
  Future<void> onServiceModal() async {
    ...
    showDialog(
      ...
      builder: (BuildContext context) {
        return AlertDialog(
          scrollable: true,
          title: Text('Choose Service'.tr, style: const TextStyle(fontSize: 14, fontFamily: 'bold'), textAlign: TextAlign.center),
          content: Column(
            children: [
              SizedBox(
                height: 200.0, // Change as per your requirement
                  ...
                  child: ListView.builder(
                    ...
                    itemBuilder: (BuildContext context, int index) {
                      ...
                      return ListTile(
                        textColor: ThemeProvider.appColor,
                        iconColor: ThemeProvider.appColor,
                        title: Text(appointmentDetail.items!.services![index].name.toString()),
                        leading: Radio(
                          fillColor: WidgetStateProperty.resolveWith(getColor),
                          value: appointmentDetail.items!.services![index].id.toString(),
                          groupValue: serviceId,
                          onChanged: (e) {
                            serviceId = e.toString();
                            serviceName = appointmentDetail.items!.services!.firstWhere((element) => element.id.toString() == serviceId).name.toString();
                            update();
                            Navigator.pop(context);
                          },
                        ),
  ...
  Future<void> onPackageModal() async {
    ...
    showDialog(
        ...
        builder: (BuildContext context) {
          return AlertDialog(
            scrollable: true,
            title: Text('Choose Package'.tr, style: const TextStyle(fontSize: 14, fontFamily: 'bold'), textAlign: TextAlign.center),
            content: Column(
              children: [
                SizedBox(
                  height: 200.0, // Change as per your requirement
                    ...
                    child: ListView.builder(
                      ...
                      itemBuilder: (BuildContext context, int index) {
                        ...
                        return ListTile(
                          textColor: ThemeProvider.appColor,
                          iconColor: ThemeProvider.appColor,
                          title: Text(appointmentDetail.items!.packages![index].name.toString()),
                          leading: Radio(
                              fillColor: WidgetStateProperty.resolveWith(getColor),
                              value: appointmentDetail.items!.packages![index].id.toString(),
                              groupValue: serviceId,
                              onChanged: (e) {
                                serviceId = e.toString();
                                serviceName = appointmentDetail.items!.packages!.firstWhere((element) => element.id.toString() == serviceId).name.toString();
                                update();
                                Navigator.pop(context);
                              }),
                        );
  ...
  Future<void> onProductModal() async {
    ...
    showDialog(
      ...
      builder: (BuildContext context) {
        return AlertDialog(
          scrollable: true,
          title: Text('Choose Product'.tr, style: const TextStyle(fontSize: 14, fontFamily: 'bold'), textAlign: TextAlign.center),
          content: Column(
            children: [
              SizedBox(
                height: 200.0, // Change as per your requirement
                      ...
                      return ListTile(
                        ...
                        leading: Radio(
                          ...
                          onChanged: (e) {
                            ...
                            productName = details.orders!.firstWhere((element) => element.id.toString() == productId).name.toString();
                            update();
                            Navigator.pop(context);
                          },
                        ),
  ...
  Future<void> onSubmit() async {
    if (issueWith != '' && selectedReason != '' && title.text != '' && comments.text != '') {
