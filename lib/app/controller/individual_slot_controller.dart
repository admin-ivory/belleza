...
class IndividualSlotController extends GetxController implements GetxService {
  ...
  void onInit() {
    ...
    if (Get.find<IndividualCheckoutController>().savedInCart.services!.isNotEmpty || Get.find<IndividualCheckoutController>().savedInCart.packages!.isNotEmpty) {
      if (Get.find<IndividualCheckoutController>().savedInCart.services!.isNotEmpty) {
        uid = Get.find<IndividualCheckoutController>().savedInCart.services![0].uid.toString();
      } else if (Get.find<IndividualCheckoutController>().savedInCart.packages!.isNotEmpty) {
        uid = Get.find<IndividualCheckoutController>().savedInCart.packages![0].uid.toString();
      }
