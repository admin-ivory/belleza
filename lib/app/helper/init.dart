...
import 'package:user/app/backend/parse/account_chat_parse.dart';
...
import 'package:user/app/backend/parse/all_categories_parse.dart';
...
import 'package:user/app/backend/parse/contact_us_parse.dart';
...
import 'package:user/app/backend/parse/individual_categories_parse.dart';
import 'package:user/app/backend/parse/individual_checkout_parse.dart';
import 'package:user/app/backend/parse/individual_list_parse.dart';
import 'package:user/app/backend/parse/individual_packages_parse.dart';
import 'package:user/app/backend/parse/individual_payment_parse.dart';
import 'package:user/app/backend/parse/individual_slot_parse.dart';
import 'package:user/app/backend/parse/intro_parse.dart';
import 'package:user/app/backend/parse/languages_parse.dart';
...
import 'package:user/app/backend/parse/packages_details_parse.dart';
...
import 'package:user/app/backend/parse/product_order_parse.dart';
import 'package:user/app/backend/parse/product_payment_parse.dart';
import 'package:user/app/backend/parse/products_details_parse.dart';
import 'package:user/app/backend/parse/products_parse.dart';
...
import 'package:user/app/backend/parse/sidemenu_parse.dart';
import 'package:user/app/backend/parse/slot_parse.dart';
import 'package:user/app/backend/parse/sortby_parse.dart';
import 'package:user/app/backend/parse/specialist_parse.dart';
import 'package:user/app/backend/parse/splash_parse.dart';
import 'package:user/app/backend/parse/stripe_pay_parse.dart';
import 'package:user/app/backend/parse/stripe_pay_product_parse.dart';
import 'package:user/app/backend/parse/tabs_parse.dart';
import 'package:user/app/backend/parse/top_offers_parse.dart';
...
import 'package:user/app/backend/parse/top_specialist_parse.dart';
import 'package:user/app/backend/parse/wallet_parse.dart';
import 'package:user/app/backend/parse/web_payment_parse.dart';
import 'package:user/app/backend/parse/web_product_payment_parse.dart';
...
class MainBinding extends Bindings {
  ...
  Future<void> dependencies() async {
    ...
    // Parser LazyLoad
    Get.lazyPut(() => IntroParser(apiService: Get.find(), sharedPreferencesManager: Get.find()), fenix: true);
    ...
    Get.lazyPut(() => NearParser(apiService: Get.find(), sharedPreferencesManager: Get.find()), fenix: true);
    ...
    Get.lazyPut(() => SearchParser(apiService: Get.find(), sharedPreferencesManager: Get.find()), fenix: true);
    ...
    Get.lazyPut(() => ReferAndEarnParser(apiService: Get.find(), sharedPreferencesManager: Get.find()), fenix: true);

    Get.lazyPut(() => LanguagesParser(apiService: Get.find(), sharedPreferencesManager: Get.find()), fenix: true);

    Get.lazyPut(() => AccountChatParser(apiService: Get.find(), sharedPreferencesManager: Get.find()), fenix: true);

    Get.lazyPut(() => ContactUsParser(apiService: Get.find(), sharedPreferencesManager: Get.find()), fenix: true);

    Get.lazyPut(() => NewAddressParser(apiService: Get.find(), sharedPreferencesManager: Get.find()), fenix: true);
    ...
    Get.lazyPut(() => ProductsDetailsParser(apiService: Get.find(), sharedPreferencesManager: Get.find()), fenix: true);

    Get.lazyPut(() => SortByParser(apiService: Get.find(), sharedPreferencesManager: Get.find()), fenix: true);
    ...
    Get.lazyPut(() => AllCategoriesParser(apiService: Get.find(), sharedPreferencesManager: Get.find()), fenix: true);

    Get.lazyPut(() => TopSpecialistParser(apiService: Get.find(), sharedPreferencesManager: Get.find()), fenix: true);

    Get.lazyPut(() => TopOffersParser(apiService: Get.find(), sharedPreferencesManager: Get.find()), fenix: true);

    Get.lazyPut(() => TopPackagesParser(apiService: Get.find(), sharedPreferencesManager: Get.find()), fenix: true);

    Get.lazyPut(() => SideMenuParser(apiService: Get.find(), sharedPreferencesManager: Get.find()), fenix: true);
    ...
    Get.lazyPut(() => CategoriesListParser(apiService: Get.find(), sharedPreferencesManager: Get.find()), fenix: true);

    Get.lazyPut(() => SelectedServicesParser(apiService: Get.find(), sharedPreferencesManager: Get.find()), fenix: true);

    Get.lazyPut(() => PackagesDetailsParser(apiService: Get.find(), sharedPreferencesManager: Get.find()), fenix: true);

    Get.lazyPut(() => ServiceCartParser(sharedPreferencesManager: Get.find(), apiService: Get.find()), fenix: true);

    Get.lazyPut(() => ProductCartParser(sharedPreferencesManager: Get.find(), apiService: Get.find()), fenix: true);

    Get.lazyPut(() => FavoritesParser(sharedPreferencesManager: Get.find(), apiService: Get.find()), fenix: true);

    Get.lazyPut(() => CouponParser(sharedPreferencesManager: Get.find(), apiService: Get.find()), fenix: true);

    Get.lazyPut(() => SlotParser(sharedPreferencesManager: Get.find(), apiService: Get.find()), fenix: true);

    Get.lazyPut(() => PaymentParser(sharedPreferencesManager: Get.find(), apiService: Get.find()), fenix: true);
    ...
    Get.lazyPut(() => StripePayProductParse(sharedPreferencesManager: Get.find(), apiService: Get.find()), fenix: true);

    Get.lazyPut(() => WebPaymentParse(sharedPreferencesManager: Get.find(), apiService: Get.find()), fenix: true);

    Get.lazyPut(() => WebProductPaymentParse(sharedPreferencesManager: Get.find(), apiService: Get.find()), fenix: true);

    Get.lazyPut(() => IndividualCategoriesParser(sharedPreferencesManager: Get.find(), apiService: Get.find()), fenix: true);

    Get.lazyPut(() => IndividualPackagesParser(sharedPreferencesManager: Get.find(), apiService: Get.find()), fenix: true);

    Get.lazyPut(() => IndividualCheckoutParser(sharedPreferencesManager: Get.find(), apiService: Get.find()), fenix: true);

    Get.lazyPut(() => IndividualListParser(sharedPreferencesManager: Get.find(), apiService: Get.find()), fenix: true);

    Get.lazyPut(() => IndividualSlotParser(sharedPreferencesManager: Get.find(), apiService: Get.find()), fenix: true);

    Get.lazyPut(() => IndividualPaymentParser(sharedPreferencesManager: Get.find(), apiService: Get.find()), fenix: true);

    Get.lazyPut(() => ProductPaymentParser(sharedPreferencesManager: Get.find(), apiService: Get.find()), fenix: true);

    Get.lazyPut(() => AddressListParser(sharedPreferencesManager: Get.find(), apiService: Get.find()), fenix: true);

    Get.lazyPut(() => ProductOrderParser(sharedPreferencesManager: Get.find(), apiService: Get.find()), fenix: true);
    ...
    Get.lazyPut(() => TopProductsParser(sharedPreferencesManager: Get.find(), apiService: Get.find()), fenix: true);

    Get.lazyPut(() => AddReviewParser(sharedPreferencesManager: Get.find(), apiService: Get.find()), fenix: true);
    ...
    Get.lazyPut(() => AddressListController(parser: Get.find()), fenix: true);
    Get.lazyPut(() => AddressController(parser: Get.find()), fenix: true);
    Get.lazyPut(() => TopProductsControllrer(parser: Get.find()), fenix: true);
