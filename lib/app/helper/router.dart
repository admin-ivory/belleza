...
import 'package:user/app/backend/binding/account_chat_binding.dart';
...
import 'package:user/app/backend/binding/all_categories_binding.dart';
import 'package:user/app/backend/binding/app_pages_binding.dart';
...
import 'package:user/app/backend/binding/categories_list_binding.dart';
...
import 'package:user/app/backend/binding/contact_us_binding.dart';
import 'package:user/app/backend/binding/coupon_binding.dart';
...
import 'package:user/app/backend/binding/individual_categories_binding.dart';
import 'package:user/app/backend/binding/individual_checkout_binding.dart';
import 'package:user/app/backend/binding/individual_list_binding.dart';
import 'package:user/app/backend/binding/individual_packages_binding.dart';
import 'package:user/app/backend/binding/individual_payment_binding.dart';
import 'package:user/app/backend/binding/individual_slot_binding.dart';
...
import 'package:user/app/backend/binding/payment_binding.dart';
import 'package:user/app/backend/binding/product_order_binding.dart';
import 'package:user/app/backend/binding/product_order_detail_binding.dart';
import 'package:user/app/backend/binding/product_payment_binding.dart';
import 'package:user/app/backend/binding/products_binding.dart';
import 'package:user/app/backend/binding/products_details_binding.dart';
import 'package:user/app/backend/binding/refer_and_earn_binding.dart';
...
import 'package:user/app/backend/binding/selected_services_binding.dart';
import 'package:user/app/backend/binding/services_binding.dart';
import 'package:user/app/backend/binding/slot_binding.dart';
import 'package:user/app/backend/binding/sortby_binding.dart';
import 'package:user/app/backend/binding/specialist_binding.dart';
...
import 'package:user/app/backend/binding/stripe_pay_product_binding.dart';
import 'package:user/app/backend/binding/tabs_binding.dart';
import 'package:user/app/backend/binding/top_offers_binding.dart';
import 'package:user/app/backend/binding/top_packages_binding.dart';
import 'package:user/app/backend/binding/top_products_binding.dart';
import 'package:user/app/backend/binding/top_specialist_binding.dart';
...
import 'package:user/app/view/address_list.dart';
import 'package:user/app/view/all_categories.dart';
...
import 'package:user/app/view/categories_list.dart';
import 'package:user/app/view/chat.dart';
import 'package:user/app/view/checkout.dart';
import 'package:user/app/view/choose_location.dart';
import 'package:user/app/view/complaints.dart';
import 'package:user/app/view/contact_us.dart';
...
import 'package:user/app/view/individual_categories.dart';
import 'package:user/app/view/individual_checkout.dart';
import 'package:user/app/view/individual_list.dart';
import 'package:user/app/view/individual_packages.dart';
import 'package:user/app/view/individual_payment.dart';
import 'package:user/app/view/individual_slot.dart';
...
import 'package:user/app/view/payment.dart';
import 'package:user/app/view/product_order.dart';
import 'package:user/app/view/product_order_detail.dart';
import 'package:user/app/view/product_payment.dart';
import 'package:user/app/view/product_stripe_pay.dart';
import 'package:user/app/view/products.dart';
import 'package:user/app/view/products_details.dart';
import 'package:user/app/view/refer_and_earn.dart';
import 'package:user/app/view/register.dart';
import 'package:user/app/view/reset_password.dart';
import 'package:user/app/view/search.dart';
import 'package:user/app/view/selected_services.dart';
import 'package:user/app/view/services.dart';
import 'package:user/app/view/slot.dart';
import 'package:user/app/view/sortby.dart';
import 'package:user/app/view/specialist.dart';
...
import 'package:user/app/view/top_offers.dart';
import 'package:user/app/view/top_packages.dart';
import 'package:user/app/view/top_products.dart';
import 'package:user/app/view/top_specialist.dart';
...
class AppRouter {
  ...
  static List<GetPage> routes = [
    ...
    GetPage(name: tabsBarRoutes, page: () => const TabScreen(), binding: TabsBinding()),
    GetPage(name: homeRoutes, page: () => const HomeScreen(), binding: HomeBinding()),
    GetPage(name: categoriesRoutes, page: () => const CategoriesScreen(), binding: CategoriesBinding()),
    GetPage(name: nearRoutes, page: () => const NearScreen(), binding: NearBinding()),
    GetPage(name: bookingRoutes, page: () => const BookingScreen(), binding: BookingBinding()),
    GetPage(name: accountRoutes, page: () => const AccountScreen(), binding: AccountBinding()),
    GetPage(name: filterRoutes, page: () => const FilterScreen(), binding: FilterBinding(), fullscreenDialog: true),
    ...
    GetPage(name: specialistRoutes, page: () => const SpecialistScreen(), binding: SpecialistBinding()),
    GetPage(name: appointmentDetailRoutes, page: () => const AppointmentDetailScreen(), binding: AppointmentDetailBinding()),
    GetPage(name: addressRoutes, page: () => const AddressScreen(), binding: AddressBinding()),
    GetPage(name: walletRoutes, page: () => const WalletScreen(), binding: WalletBinding()),
    GetPage(name: referAndEarnRoutes, page: () => const ReferAndEarnScreen(), binding: ReferAndEarnBinding()),
    GetPage(name: languagesRoutes, page: () => const LanguagesScreen(), binding: LanguagesBinding()),
    GetPage(name: accountChatRoutes, page: () => const AccountChatScreen(), binding: AccountChatBinding()),
    GetPage(name: contactUsRoutes, page: () => const ContactUsScreen(), binding: ContactUsBinding()),
    GetPage(name: newAddressRoutes, page: () => const NewAddressScreen(), binding: NewAddressBinding()),
    ...
    GetPage(name: productsDetailsRoutes, page: () => const ProductsDetailsScreen(), binding: ProductsDetailsBinding()),
    GetPage(name: sortByRoutes, page: () => const SortByScreen(), binding: SortByBinding(), fullscreenDialog: true),
    GetPage(name: cartRoutes, page: () => const CartScreen(), binding: CartBinding()),
    GetPage(name: checkoutRoutes, page: () => const CheckoutScreen(), binding: CheckoutBinding()),
    GetPage(name: allCategoriesRoutes, page: () => const AllCategoriesScreen(), binding: AllCategoriesBinding()),
    GetPage(name: topSpecialistRoutes, page: () => const TopSpecialistScreen(), binding: TopSpecialistBinding()),
    GetPage(name: topOffersRoutes, page: () => const TopOffersScreen(), binding: TopOffersBinding()),
    GetPage(name: topPackagesRoutes, page: () => const TopPackagesScreen(), binding: TopPackagesBinding()),
    GetPage(name: chooseLocationRoutes, page: () => const ChooseLocationScreen(), binding: ChooseLocationBinding()),
    GetPage(name: findLocationRoutes, page: () => const FindLocationScreen(), binding: FindLocationBinding(), fullscreenDialog: true),
    GetPage(name: categoriesListRoutes, page: () => const CategoriesListScreen(), binding: CategoriesListBinding()),
    GetPage(name: selectedServicesRoutes, page: () => const SelectedServicesScreen(), binding: SelectedServicesBinding(), fullscreenDialog: true),
    GetPage(name: packagesDetailsRoutes, page: () => const PackagesDetailsScreen(), binding: PackagesDetailsBinding(), fullscreenDialog: true),
    GetPage(name: couponRoutes, page: () => const CouponScreen(), binding: CouponBinding(), fullscreenDialog: true),
    GetPage(name: slotRoutes, page: () => const SlotScreen(), binding: SlotBinding()),
    GetPage(name: paymentRoutes, page: () => const PaymentScreen(), binding: PaymentBinding()),
    GetPage(name: errorRoutes, page: () => const ErrorScreen()),
    GetPage(name: addNewCardRoutes, page: () => const AddCardScreen(), binding: AddCardBinding()),
    GetPage(name: stripePayRoutes, page: () => const StripePay(), binding: StripePayBinding()),
    GetPage(name: stripePayProductRoutes, page: () => const ProductStripePay(), binding: StripePayProductBinding()),
    GetPage(name: webPaymentRoutes, page: () => const WebPayment(), binding: WebPaymentBinding()),
    GetPage(name: webProductPaymentRoutes, page: () => const WebProductPayment(), binding: WebProductPaymentBinding()),
    GetPage(name: individualCategoriesRoutes, page: () => const IndividualCategoriesScreen(), binding: IndividualCategoriesBinding()),
    GetPage(name: individualPackagesRoutes, page: () => const IndividualPackagesScreen(), binding: IndividualPackagesBinding(), fullscreenDialog: true),
    GetPage(name: individualCheckoutRoutes, page: () => const IndividualCheckoutScreen(), binding: IndividualCheckoutBinding()),
    GetPage(name: individualListRoutes, page: () => const IndividualListScreen(), binding: IndividualListBinding(), fullscreenDialog: true),
    GetPage(name: individualSlotRoutes, page: () => const IndividualSlotScreen(), binding: IndividualSlotBinding()),
    GetPage(name: individualPaymentRoutes, page: () => const IndividualPaymentScreen(), binding: IndividualPaymentBinding()),
    GetPage(name: productPaymentRoutes, page: () => const ProductPaymentScreen(), binding: ProductPaymentBinding()),
    GetPage(name: addressListRoutes, page: () => const AddressListScreen(), binding: AddressListBinding(), fullscreenDialog: true),
    GetPage(name: productOrderRoutes, page: () => const ProductOrderScreen(), binding: ProductOrderBinding()),
    GetPage(name: productOrderDetailRoutes, page: () => const ProductOrderDetail(), binding: ProductOrderDetailBinding()),
