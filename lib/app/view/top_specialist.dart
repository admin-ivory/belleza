                                      ...
                                      children: [
                                        Padding(
                                          ...
                                          child: RichText(
                                            text: TextSpan(
                                              children: [
                                                TextSpan(text: 'Fee start from '.tr, style: const TextStyle(fontSize: 12, color: ThemeProvider.greyColor)),
                                                TextSpan(
                                                  text: value.currencySide == 'left' ? value.currencySymbol + item.feeStart.toString() : item.feeStart.toString() + value.currencySymbol,
                                                  style: const TextStyle(fontSize: 15, color: ThemeProvider.appColor, fontFamily: 'bold'),
                                                ),
                                              ],
                                            ),
                                          ),
