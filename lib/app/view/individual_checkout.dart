                      ...
                      children: [
                        ...
                        Padding(
                          ...
                          child: Row(
                            ...
                            children: [
                              Expanded(
                                child: Text('Taxes & Charges'.tr, overflow: TextOverflow.ellipsis),
                              ),
                              Text(
                                value.currencySide == 'left' ? '${value.currencySymbol} ${Get.find<ServiceCartController>().orderTax}' : ' ${Get.find<ServiceCartController>().orderTax}${value.currencySymbol}',
                              ),
                            ],
                          ),
                        ),
                        ...
                        Padding(
                          ...
                          child: Row(
                            ...
                            children: [
                              ...
                              Text(
                                value.currencySide == 'left' ? '${value.currencySymbol} ${Get.find<ServiceCartController>().grandTotal}' : ' ${Get.find<ServiceCartController>().grandTotal}${value.currencySymbol}',
              ...
              children: [
                InkWell(
                  ...
                  child: Container(
                    ...
                    child: Row(mainAxisAlignment: MainAxisAlignment.center, children: [Text('Select Date & Time'.tr, style: const TextStyle(color: ThemeProvider.whiteColor, fontSize: 17))]),
                  ),
                ),
              ],
            ),
