                                        ...
                                        Expanded(
                                          child: Column(
                                            ...
                                            children: [
                                              ...
                                              Text(item.address.toString(), maxLines: 2, overflow: TextOverflow.ellipsis, style: const TextStyle(fontSize: 12)),
                                                ...
                                                children: [
                                                  ...
                                                  Container(
                                                    ...
                                                    child: InkWell(
                                                      ...
                                                      child: Center(child: Text('Continue'.tr, style: const TextStyle(fontSize: 10, fontFamily: 'bold', color: ThemeProvider.whiteColor))),
                                                    ),
                                                  ),
                                                ],
                                              ),
