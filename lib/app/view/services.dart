                      ...
                      title: Column(
                        children: [
                                      ...
                                      child: Row(
                                        ...
                                        children: [
                                          ...
                                          CircleAvatar(
                                            radius: 20,
                                            backgroundColor: ThemeProvider.transparent,
                                            child: IconButton(onPressed: () {}, icon: const Icon(Icons.save_alt, color: ThemeProvider.whiteColor)),
                                          ),
                                        ],
                                      ),
                                    ),
                            ...
                            child: Row(
                              ...
                              children: [
                                InkWell(
                                  ...
                                  child: Column(
                                    children: [
                                      const Icon(Icons.language, size: 40, color: ThemeProvider.orangeColor),
                                      Text('Website'.tr, style: const TextStyle(fontSize: 12, color: ThemeProvider.greyColor)),
                                    ],
                                  ),
                                ),
                                InkWell(
                                  onTap: () => value.callSalon(),
                                  child: Column(
                                    children: [
                                      const Icon(Icons.call, size: 40, color: ThemeProvider.orangeColor),
                                ...
                                InkWell(
                                  ...
                                  child: Column(
                                    children: [
                                      const Icon(Icons.chat_outlined, size: 40, color: ThemeProvider.orangeColor),
                                ...
                                InkWell(
                                  ...
                                  child: Column(
                                    children: [
                                      const Icon(Icons.directions, size: 40, color: ThemeProvider.orangeColor),
                                ...
                                InkWell(
                                  ...
                                  child: Column(
                                    children: [
                                      const Icon(Icons.offline_share, size: 40, color: ThemeProvider.orangeColor),
                          ...
                          Padding(
                            ...
                            child: Row(
                              children: [
                                Text('Salon Specialist'.tr, style: const TextStyle(fontSize: 14, fontFamily: 'bold', color: ThemeProvider.blackColor)),
                              ],
                            ),
                          ),
                          Padding(
                                      ...
                                      child: Column(
                                        children: [
                                          ...
                                          Padding(
                                            ...
                                            child: Text('${item.firstName} ${item.lastName}', style: const TextStyle(fontSize: 12, color: ThemeProvider.blackColor)),
                                          ),
                                        ],
                                      ),
                                    )
                                      ...
                                      children: [
                                        Column(
                                          ...
                                          children: [
                                            ...
                                            Text(value.salonDetails.about.toString(), style: const TextStyle(color: ThemeProvider.blackColor, fontSize: 15)),
                                            Padding(
                                              padding: const EdgeInsets.symmetric(vertical: 10),
                                              child: Row(
                                                    ...
                                                    children: [
                                                      ...
                                                      Expanded(
                                                        child: Row(
                                                          mainAxisAlignment: MainAxisAlignment.spaceBetween,
                                                          children: [
                                                            Text(value.dayList[value.salonDetails.timing![index].day as int], style: const TextStyle(color: ThemeProvider.greyColor, fontSize: 12)),
                                                            Text(
                                            ...
                                            Padding(
                                              padding: const EdgeInsets.symmetric(vertical: 10),
                                              child: Row(
                                                children: [Text('Address'.tr, style: const TextStyle(fontSize: 14, fontFamily: 'bold', color: ThemeProvider.blackColor))],
                                              ),
                                            ),
                                            Row(
                                              mainAxisAlignment: MainAxisAlignment.spaceBetween,
                                                      ...
                                                      RichText(
                                                        text: TextSpan(
                                                          children: [
                                                            ...
                                                            TextSpan(text: '${' Get Direction - '.tr}${value.getDistance}KM', style: const TextStyle(fontSize: 12, color: ThemeProvider.orangeColor)),
                                                          ],
                                                        ),
                                                      ),
                                                    ],
                                                          ...
                                                          children: [
                                                            Padding(
                                                              ...
                                                              child: Row(
                                                                mainAxisAlignment: MainAxisAlignment.spaceBetween,
                                                                children: [
                                                                  Text(item.name.toString(), style: const TextStyle(color: ThemeProvider.blackColor, fontSize: 14)),
                                                                  InkWell(
                                                            ...
                                                            Row(
                                                              mainAxisAlignment: MainAxisAlignment.spaceBetween,
                                                              children: [
                                                                Text(item.services.toString() + '  Type'.tr, style: const TextStyle(color: ThemeProvider.greyColor, fontSize: 12)),
                                                              ],
                                                            ),
                                                          ],
                                                        ),
                                    ...
                                    child: Column(
                                      children: [
                                        Padding(
                                          ...
                                          child: Row(
                                            children: [Text('${'All Reviews '.tr}(${value.ownerReviewsList.length})', style: const TextStyle(color: ThemeProvider.greyColor))],
                                          ),
                                        ),
