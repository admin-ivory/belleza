                                    ...
                                    children: [
                                      Padding(
                                        ...
                                        child: Row(
                                          mainAxisAlignment: MainAxisAlignment.spaceBetween,
                                          children: [
                                            Text('Top Categories'.tr, style: const TextStyle(fontSize: 14, fontFamily: 'bold')),
                                            TextButton(
                                              onPressed: () => value.onAllCategories(),
                                              style: TextButton.styleFrom(textStyle: const TextStyle(fontSize: 14, color: ThemeProvider.blackColor)),
                                              child: Text('View all'.tr, style: const TextStyle(color: ThemeProvider.appColor, fontSize: 12)),
                                            ),
                                          ],
                                        ),
                                      ),
                                                      ...
                                                      Column(
                                                        children: [
                                                          Padding(
                                                            padding: const EdgeInsets.only(top: 10),
                                                            child: Text(
                                                              item.name!.length > 15 ? '${item.name!.substring(0, 15)}...' : item.name.toString(),
                                      ...
                                      Row(
                                        mainAxisAlignment: MainAxisAlignment.spaceBetween,
                                        children: [
                                          Text('Top Specialist'.tr, style: const TextStyle(fontSize: 14, fontFamily: 'bold')),
                                          TextButton(
                                              ...
                                              Padding(
                                                ...
                                                child: Column(
                                                  children: [
                                                    ...
                                                    const SizedBox(height: 5),
                                                    Text(item.userInfo!.firstName.toString(), style: const TextStyle(fontFamily: 'semibold')),
                                                    Text(item.userInfo!.lastName.toString(), style: const TextStyle(fontSize: 10)),
                                                  ],
                                                ),
                                              )
                                          ],
                                      ...
                                      Row(
                                        mainAxisAlignment: MainAxisAlignment.spaceBetween,
                                        children: [
                                          Text('Top Salon'.tr, style: const TextStyle(fontSize: 14, fontFamily: 'bold')),
                                          TextButton(
                                                              ...
                                                              children: [
                                                                    ...
                                                                    children: [
                                                                      Padding(
                                                                        ...
                                                                        child: Row(
                                                                          mainAxisAlignment: MainAxisAlignment.spaceBetween,
                                                                          children: [
                                                                            Expanded(child: Text(item.name.toString(), overflow: TextOverflow.ellipsis, style: const TextStyle(fontSize: 15))),
                                                                            Row(
                                                                              children: [
                                                                                const Icon(Icons.star, color: Colors.orange, size: 17),
                                                                                const SizedBox(width: 5),
                                                                                Text(item.rating.toString(), style: const TextStyle(fontSize: 15))
                                                                              ],
                                                                            ),
                                                                          ],
                                                                        ),
                                                                ...
                                                                Positioned(
                                                                  ...
                                                                  child: Container(
                                                                    ...
                                                                    child: Row(
                                                                      mainAxisAlignment: MainAxisAlignment.center,
                                                                      children: [Text('Book'.tr, style: const TextStyle(fontSize: 10, color: Colors.white))],
                                                                    ),
                                                                  ),
                                                                ),
                                                              ],
                                      ...
                                      Row(
                                        mainAxisAlignment: MainAxisAlignment.spaceBetween,
                                        children: [
                                          Text('Top Products'.tr, style: const TextStyle(fontSize: 14, fontFamily: 'bold')),
                                          TextButton(
