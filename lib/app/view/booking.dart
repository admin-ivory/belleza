                                ...
                                ? Column(
                                    ...
                                    children: List.generate(
                                      ...
                                      (index) => Column(
                                        ...
                                        children: [
                                          Banner(
                                            message: value.statusName[value.appointmentList[index].status as int].tr,
                                            ...
                                            child: Container(
                                              ...
                                              child: InkWell(
                                                onTap: () => value.onAppointment(value.appointmentList[index].id as int),
                                                child: Column(
                                                  crossAxisAlignment: CrossAxisAlignment.start,
                                                  mainAxisAlignment: MainAxisAlignment.start,
                                                  children: [
                                                    Row(
                                                      crossAxisAlignment: CrossAxisAlignment.start,
                                                      children: [
                                                        value.appointmentList[index].salonId != 0
                                                            ? Padding(
                                                        ...
                                                        Expanded(
                                                          child: Column(
                                                            ...
                                                            children: [
                                                              value.appointmentList[index].salonId != 0
                                                                  ? Text(
                                                                      value.appointmentList[index].salonInfo!.name.toString(),
                                                              ...
                                                              Row(
                                                                children: [
                                                                  value.appointmentList[index].salonId != 0
                                                                      ? Expanded(
                                                                          child: Text(
                                                                            value.appointmentList[index].salonInfo!.address.toString(),
                                                                            overflow: TextOverflow.ellipsis,
                                                                            maxLines: 2,
                                                                      ...
                                                                      : Expanded(
                                                                          child: Text(
                                                                            value.appointmentList[index].individualInfo!.address.toString(),
                                                                            overflow: TextOverflow.ellipsis,
                                                                            maxLines: 2,
                                                                            style: const TextStyle(fontSize: 11, color: ThemeProvider.blackColor),
                                                                          ),
                                                    ...
                                                    Row(
                                                      ...
                                                      crossAxisAlignment: CrossAxisAlignment.center,
                                                      children: [
                                                        Text('Appointment at :'.tr, style: const TextStyle(fontSize: 12, color: ThemeProvider.appColor)),
                                                        Text('${value.appointmentList[index].saveDate} ${value.appointmentList[index].slot}', style: const TextStyle(fontSize: 12))
                                                      ],
                                                    ),
                                                  ],
                                                ),
                                ...
                                : Center(
                                    child: Column(
                                      ...
                                      children: [
                                        ...
                                        Text('No New Appointment Found!'.tr, style: const TextStyle(fontFamily: 'bold', color: ThemeProvider.appColor)),
                                      ],
                                    ),
                                  ),
                          ),
                                ...
                                ? Column(
                                    children: List.generate(
                                      ...
                                      (index) => Column(
                                        children: [
                                          Banner(
                                            message: value.statusName[value.appointmentListOld[index].status as int].tr,
                                            color: ThemeProvider.appColor,
                                            location: BannerLocation.topStart,
                                            child: Container(
                                              padding: const EdgeInsets.all(10),
                                              ...
                                              child: InkWell(
                                                onTap: () => value.onAppointment(value.appointmentListOld[index].id as int),
                                                child: Column(
                                                  children: [
                                                    Row(
                                                      crossAxisAlignment: CrossAxisAlignment.start,
                                                      children: [
                                                        value.appointmentListOld[index].salonId != 0
                                                            ? Padding(
                                                                padding: const EdgeInsets.only(right: 10),
                                                                child: ClipRRect(
                                                                  borderRadius: BorderRadius.circular(5),
                                                        ...
                                                        Expanded(
                                                          child: Column(
                                                            ...
                                                            children: [
                                                              value.appointmentListOld[index].salonId != 0
                                                                  ? Text(
                                                                      value.appointmentListOld[index].salonInfo!.name.toString(),
                                                                      overflow: TextOverflow.ellipsis,
                                                                      style: const TextStyle(fontFamily: 'bold', fontSize: 12, color: ThemeProvider.blackColor),
                                                                    )
                                                                  : Text(
                                                              ...
                                                              Row(
                                                                children: [
                                                                  value.appointmentListOld[index].salonId != 0
                                                                      ? Expanded(
                                                                          child: Text(
                                                                            value.appointmentListOld[index].salonInfo!.address.toString(),
                                                                            overflow: TextOverflow.ellipsis,
                                                                            maxLines: 2,
                                                                            style: const TextStyle(fontSize: 11, color: ThemeProvider.blackColor),
                                                                          ),
                                                                      ...
                                                                      : Expanded(
                                                                          child: Text(
                                                                            value.appointmentListOld[index].individualInfo!.address.toString(),
                                                                            overflow: TextOverflow.ellipsis,
                                                                            maxLines: 2,
                                                                            style: const TextStyle(fontSize: 11, color: ThemeProvider.blackColor),
                                                                          ),
                                                                    ...
                                                                    RichText(
                                                                      text: TextSpan(
                                                                        children: [
                                                                          TextSpan(
                                                                            text: value.currencySide == 'left'
                                                                                ? value.currencySymbol + value.appointmentListOld[index].items!.packages![packageIndex].price.toString()
                                                                                : value.appointmentListOld[index].items!.packages![packageIndex].price.toString() + value.currencySymbol,
                                                                            style: const TextStyle(fontSize: 10, color: ThemeProvider.blackColor, decoration: TextDecoration.lineThrough),
                                                                          ),
                                                                          const TextSpan(text: ' '),
                                                                          TextSpan(
                                                                            text: value.currencySide == 'left'
                                                                                ? value.currencySymbol + value.appointmentListOld[index].items!.packages![packageIndex].off.toString()
                                                                                : value.appointmentListOld[index].items!.packages![packageIndex].off.toString() + value.currencySymbol,
                                                                            style: const TextStyle(fontSize: 10, color: ThemeProvider.blackColor, fontFamily: 'bold'),
                                                                          ),
                                                                        ],
                                                                      ),
                                                    ...
                                                    Row(
                                                      ...
                                                      children: [
                                                        Text('Appointment at :'.tr, style: const TextStyle(fontSize: 12, color: ThemeProvider.appColor)),
                                                        Text('${value.appointmentListOld[index].saveDate} ${value.appointmentListOld[index].slot}', style: const TextStyle(fontSize: 12))
                                                      ],
                                                    ),
                                                  ],
                                                ),
                                ...
                                : Center(
                                    child: Column(
                                      ...
                                      children: [
                                        Image.asset('assets/images/no-data.png', width: 60, height: 60),
                                        const SizedBox(height: 30),
                                        Text('No Past Appointment Found!'.tr, style: const TextStyle(fontFamily: 'bold', color: ThemeProvider.appColor)),
                                      ],
                                    ),
                                  ),
                          ),
