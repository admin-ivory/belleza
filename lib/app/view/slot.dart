        ...
        return Scaffold(
                    ...
                    child: Column(
                      children: [
                        ...
                        value.haveData == false
                            ...
                            : Row(mainAxisAlignment: MainAxisAlignment.start, children: [Text('Select Slots'.tr, style: const TextStyle(fontFamily: 'bold', fontSize: 14))]),
                        value.haveData == false
                            ? const SizedBox()
                            : Container(
                        ...
                        Row(
                          ...
                          children: [Text('Select Specialist'.tr, style: const TextStyle(fontFamily: 'bold', fontSize: 14))],
                        ),
                        SingleChildScrollView(
                                      ...
                                      children: [
                                        ClipRRect(
                                          ...
                                          child: SizedBox.fromSize(
                                            ...
                                            child: FadeInImage(
                                              image: NetworkImage('${Environments.apiBaseURL}api/storage/images/${value.specialistList[index].cover}'),
                                        ...
                                        Positioned(
                                          ...
                                          child: IconButton(
                                            ...
                                            icon: Icon(value.selectedSpecialist == value.specialistList[index].id.toString() ? Icons.check_circle_outline : Icons.circle_outlined),
          ...
          bottomNavigationBar: InkWell(
            ...
            child: Container(
              ...
              child: Row(mainAxisAlignment: MainAxisAlignment.center, children: [Text('Make Payment'.tr, style: const TextStyle(color: ThemeProvider.whiteColor, fontSize: 17))]),
            ),
          ),
        );
      },
