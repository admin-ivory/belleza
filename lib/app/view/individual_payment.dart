...
class IndividualPaymentScreen extends StatefulWidget {
  const IndividualPaymentScreen({super.key});
                              ...
                              Padding(
                                ...
                                child: Row(
                                  ...
                                  children: [
                                    ...
                                    Text(
                                      value.currencySide == 'left' ? '${value.currencySymbol} ${value.deliveryPrice}' : ' ${value.deliveryPrice}${value.currencySymbol}',
                                    ),
                                  ],
                                ),
                              ),
                              ...
                              Padding(
                                ...
                                child: Row(
                                  ...
                                  children: [
                                    ...
                                    Text(
                                      value.currencySide == 'left' ? '${value.currencySymbol} ${value.grandTotal}' : ' ${value.grandTotal}${value.currencySymbol}',
            ...
            child: Column(
              children: [
                ...
                ListTile(
                  ...
                  minLeadingWidth: 0,
                  title: Text('${Get.find<IndividualSlotController>().savedDate} ${Get.find<IndividualSlotController>().selectedSlotIndex}', style: const TextStyle(fontSize: 14)),
                  trailing: const Icon(Icons.edit_outlined, size: 14),
                  onTap: () => value.onBack(),
                ),
