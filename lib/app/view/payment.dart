                  ...
                  child: Padding(
                    ...
                    child: Column(
                      children: [
                        ...
                        //         decoration: BoxDecoration(borderRadius: BorderRadius.circular(5), color: ThemeProvider.whiteColor),
                        //         child: InkWell(
                        //           onTap: () => value.updateServiceAt(1),
                        //           child: Row(
                        //             children: [
                        //               ClipRRect(child: SizedBox.fromSize(size: const Size.fromRadius(15), child: Image.asset('assets/images/house.png', fit: BoxFit.contain))),
                        //               const SizedBox(width: 10),
                        //               Expanded(
                        //                 child: Row(
                        //                   mainAxisAlignment: MainAxisAlignment.spaceBetween,
                        //                   children: [Text('At Home'.tr, overflow: TextOverflow.ellipsis), Icon(value.appointmentsTo == 1 ? Icons.check_circle : Icons.circle_outlined, color: ThemeProvider.appColor)],
                        //                 ),
                        //               ),
                        //             ],
                        //           ),
                        ...
                        //         decoration: BoxDecoration(borderRadius: BorderRadius.circular(5), color: ThemeProvider.whiteColor),
                        //         child: InkWell(
                        //           onTap: () => value.updateServiceAt(0),
                        //           child: Row(
                        //             children: [
                        //               ClipRRect(child: SizedBox.fromSize(size: const Size.fromRadius(15), child: Image.asset('assets/images/salon.png', fit: BoxFit.contain))),
                        //               const SizedBox(width: 10),
                        //               Expanded(
                        //                 child: Row(
                        //                   mainAxisAlignment: MainAxisAlignment.spaceBetween,
                        //                   children: [
                        //                     Text('At Salon'.tr, overflow: TextOverflow.ellipsis),
                        //                     Icon(value.appointmentsTo == 0 ? Icons.check_circle : Icons.circle_outlined, color: ThemeProvider.appColor),
                        //                   ],
                        //                 ),
                        //               ),
                        //             ],
                                    ...
                                    CircleAvatar(
                                      ...
                                      child: ClipRRect(
                                        ...
                                        child: SizedBox.fromSize(
                                          ...
                                          child: FadeInImage(
                                            image: NetworkImage('${Environments.apiBaseURL}api/storage/images/${value.paymentList[index].cover}'),
