                      ...
                      child: Padding(
                        ...
                        child: Column(
                          children: [
                            Padding(
                              padding: const EdgeInsets.symmetric(vertical: 10),
                              child: Row(mainAxisAlignment: MainAxisAlignment.spaceBetween, children: [Text('Specialist'.tr, style: const TextStyle(fontSize: 14, fontFamily: 'bold'))]),
                            ),
                            Padding(
                                                ...
                                                children: [
                                                  Padding(
                                                    ...
                                                    child: Text(
                                                      ...
                                                      style: const TextStyle(fontSize: 10, color: ThemeProvider.greyColor, fontFamily: 'bold'),
                                                    ),
                                                  ),
                                                ],
                                              ),
                            ...
                            Padding(
                              padding: const EdgeInsets.symmetric(vertical: 10),
                              child: Row(mainAxisAlignment: MainAxisAlignment.spaceBetween, children: [Text('Salon'.tr, style: const TextStyle(fontSize: 14, fontFamily: 'bold'))]),
                            ),
                                        ...
                                        children: [
                                          ...
                                          Expanded(
                                            child: Column(
                                              ...
                                              children: [
                                                Text(item.name.toString(), overflow: TextOverflow.ellipsis, style: const TextStyle(fontFamily: 'bold', fontSize: 14)),
                                                ...
                                                item.categories!.length <= 2
                                                    ? Column(
                                                        ...
                                                        children: List.generate(
                                                          ...
                                                          (subIndex) => Text(item.categories![subIndex].name.toString(), overflow: TextOverflow.ellipsis),
                                                        ),
                                                      )
                                                    : Column(
                                                        crossAxisAlignment: CrossAxisAlignment.start,
                                                        mainAxisAlignment: MainAxisAlignment.start,
                                                        children: [for (var cate in item.categories!.take(2)) Text(cate.name.toString()), const Text('and more')]),
                                                const SizedBox(height: 3),
                                                RichText(
                                                  text: TextSpan(
                                                    children: [
                                                      WidgetSpan(child: Icon(Icons.star, size: 15, color: item.rating! >= 1 ? ThemeProvider.orangeColor : ThemeProvider.greyColor)),
                                                      WidgetSpan(child: Icon(Icons.star, size: 15, color: item.rating! >= 2 ? ThemeProvider.orangeColor : ThemeProvider.greyColor)),
                                                      WidgetSpan(child: Icon(Icons.star, size: 15, color: item.rating! >= 3 ? ThemeProvider.orangeColor : ThemeProvider.greyColor)),
                                                      WidgetSpan(child: Icon(Icons.star, size: 15, color: item.rating! >= 4 ? ThemeProvider.orangeColor : ThemeProvider.greyColor)),
                                                      WidgetSpan(child: Icon(Icons.star, size: 15, color: item.rating! >= 5 ? ThemeProvider.orangeColor : ThemeProvider.greyColor)),
                                                    ],
                                                  ),
                                                ),
                                              ],
