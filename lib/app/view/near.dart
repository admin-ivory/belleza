...
import 'package:user/app/helper/map_style.dart';
                            ...
                            child: Column(
                              children: [
                                Padding(
                                  ...
                                  child: Row(mainAxisAlignment: MainAxisAlignment.spaceBetween, children: [Text('Top Specialist'.tr, style: const TextStyle(fontSize: 14, fontFamily: 'bold'))]),
                                ),
                                SingleChildScrollView(
                                ...
                                Padding(
                                  ...
                                  child: SingleChildScrollView(
                                    ...
                                    child: Padding(
                                      ...
                                      child: Row(
                                        children: [
                                          for (var item in Get.find<NearController>().salonList)
                                            Container(
