        ...
        return Scaffold(
          ...
          bottomNavigationBar: InkWell(
            ...
            child: Container(
              ...
              child: Row(mainAxisAlignment: MainAxisAlignment.center, children: [Text('Continue'.tr, style: const TextStyle(color: ThemeProvider.whiteColor, fontFamily: 'bold'))]),
            ),
          ),
                    ...
                    itemBuilder: (context, i) => Column(
                      children: [
                        Container(
                          ...
                          child: Stack(
                            children: [
                              Positioned(right: 0, child: InkWell(onTap: () => value.deleteProductFromCart(i), child: const Icon(Icons.delete, size: 20, color: ThemeProvider.redColor))),
                              Column(
                                children: [
                                  Row(
                                    children: [
                                                ...
                                                RichText(
                                                  text: TextSpan(
                                                    children: [
                                                      ...
                                                      TextSpan(
                                                        text:
                                                            value.currencySide == 'left' ? '  ${value.currencySymbol}${value.savedInCart[i].originalPrice}  ' : value.savedInCart[i].originalPrice.toString() + value.currencySymbol,
                                              ...
                                              child: Row(
                                                ...
                                                children: <Widget>[
                                                  InkWell(
                                                    ...
                                                    child: const CircleAvatar(backgroundColor: ThemeProvider.transparent, child: Icon(Icons.remove, color: ThemeProvider.blackColor, size: 15)),
                                                  ),
                                                  Expanded(
                                                    child: Text(
                                                  ...
                                                  InkWell(
                                                    ...
                                                    child: const CircleAvatar(backgroundColor: ThemeProvider.transparent, child: Icon(Icons.add, color: ThemeProvider.blackColor, size: 15)),
                                                  ),
                                                ],
                                              ),
                                            ),
                                  ...
                                  Container(
                                    ...
                                    decoration: const BoxDecoration(border: Border(top: BorderSide(color: ThemeProvider.greyColor))),
                                    child: Row(
                                      mainAxisAlignment: MainAxisAlignment.spaceBetween,
                                      children: [
                                        RichText(
                                          text: TextSpan(
                                            children: [
                                              TextSpan(text: 'Special Discount : '.tr, style: const TextStyle(fontSize: 12, color: ThemeProvider.greyColor)),
                                              TextSpan(
                                                text: value.savedInCart[i].discount.toString() + ' %OFF'.tr,
                                                style: const TextStyle(fontSize: 12, color: ThemeProvider.redColor, fontFamily: 'bold'),
                                              ),
                                            ],
                                          ),
                                        ),
                                        RichText(
                                          text: TextSpan(
                                            children: [
                                              TextSpan(text: 'Total Price : '.tr, style: const TextStyle(fontSize: 12, color: ThemeProvider.greyColor)),
                                              TextSpan(
