...
class _SearchScreenState extends State<SearchScreen> {
                      ...
                      title: Column(
                        ...
                        children: [
                          Row(
                            ...
                            children: [
                              Text('Your Location'.tr, style: const TextStyle(fontSize: 12, color: ThemeProvider.whiteColor)),
                          ...
                          Row(
                            children: [
                              ...
                              Text(value.title.length > 30 ? '${value.title.substring(0, 30)}...' : value.title.toString(), style: const TextStyle(fontSize: 15, color: ThemeProvider.whiteColor)),
                              const SizedBox(width: 5),
                            ...
                            child: SizedBox(
                              ...
                              child: TextField(
                                ...
                                decoration: InputDecoration(
                                  ...
                                  enabledBorder: const OutlineInputBorder(borderRadius: BorderRadius.all(Radius.circular(10)), borderSide: BorderSide(color: ThemeProvider.transparent)),
                                  focusedBorder: const OutlineInputBorder(borderRadius: BorderRadius.all(Radius.circular(10)), borderSide: BorderSide(color: ThemeProvider.transparent)),
                                  filled: true,
                                        ...
                                        child: Padding(
                                          ...
                                          child: Column(
                                            children: [
                                                  ...
                                                  child: ClipRRect(
                                                    ...
                                                    child: SizedBox.fromSize(
                                                      ...
                                                      child: FittedBox(
                                                        fit: BoxFit.cover,
                                                        child: FadeInImage(
                                                          image: NetworkImage('${Environments.apiBaseURL}api/storage/images/${value.individualList[index].cover.toString()}'),
                                              ...
                                              Text(value.individualList[index].firstName!, style: const TextStyle(fontFamily: 'semibold')),
                                            ],
                                          ),
                                        ),
                                      ),
                                                ...
                                                ClipRRect(
                                                  ...
                                                  child: SizedBox.fromSize(
                                                    ...
                                                    child: FittedBox(
                                                      fit: BoxFit.cover,
                                                      child: FadeInImage(
                                                        image: NetworkImage('${Environments.apiBaseURL}api/storage/images/${value.salonList[index].cover.toString()}'),
                                                        placeholder: const AssetImage("assets/images/placeholder.jpeg"),
                                                        imageErrorBuilder: (context, error, stackTrace) {
                                                          return Image.asset('assets/images/notfound.png', fit: BoxFit.cover);
                                                        },
                                                      ...
                                                      children: [
                                                        Row(
                                                          ...
                                                          children: [
                                                            SizedBox(
                                                              width: 120,
                                                              child: Text(value.salonList[index].name!, overflow: TextOverflow.ellipsis, style: const TextStyle(fontFamily: 'bold', fontSize: 15)),
                                                            ),
                                                            Row(
                                                              children: [
                                                                const Icon(Icons.location_on, size: 15, color: ThemeProvider.greyColor),
                                                                Text(
                                                        ...
                                                        Row(
                                                          children: [
                                                            ...
                                                            Padding(
                                                              padding: const EdgeInsets.symmetric(horizontal: 5),
                                                              child: Text(value.salonList[index].rating.toString(), style: const TextStyle(color: ThemeProvider.greyColor, fontSize: 12)),
                                                            ),
                                                          ],
                                                        ),
                                                        Row(
                                                          ...
                                                          children: [
                                                            ...
                                                            GestureDetector(
                                                              ...
                                                              child: Container(
                                                                ...
                                                                child: Center(child: Text('Book'.tr, style: const TextStyle(color: ThemeProvider.whiteColor))),
                                                              ),
                                                            ),
                                                          ],
                                                        ),
  ...
  Widget _buildTitle(txt) {
    return Padding(padding: const EdgeInsets.symmetric(vertical: 10), child: Row(children: [Text('$txt', style: const TextStyle(fontSize: 14, fontFamily: 'bold'))]));
  }
}
