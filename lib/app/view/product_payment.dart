                    ...
                    child: Column(
                      children: [
                        ...
                        Row(
                          ...
                          children: [Text('Add Notes'.tr, style: const TextStyle(fontFamily: 'bold', fontSize: 14))],
                        ),
                        Padding(
                              ...
                              Padding(
                                ...
                                child: Row(
                                  ...
                                  children: [
                                    ...
                                    Text(value.currencySide == 'left' ? '${value.currencySymbol}${value.deliveryPrice.toString()}' : '${value.deliveryPrice.toString()}${value.currencySymbol}'),
                                  ],
                                ),
                              ),
                              Padding(
                              ...
                              Padding(
                                ...
                                child: Row(
                                  ...
                                  children: [
                                    ...
                                    Text(value.currencySide == 'left' ? '${value.currencySymbol}${value.grandTotal.toString()}' : '${value.grandTotal.toString()}${value.currencySymbol}',
            ...
            children: [
              value.apiCalled == false
                  ? Row(
                      ...
                      children: [
                        const Padding(padding: EdgeInsets.all(10.0), child: SizedBox(height: 25, width: 25, child: CircularProgressIndicator(color: ThemeProvider.appColor))),
                        Text('Please Wait'.tr, style: const TextStyle(fontFamily: 'bold')),
                      ],
                    )
                  : ListTile(
