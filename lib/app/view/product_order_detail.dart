                        ...
                        children: [
                          Container(
                            ...
                            decoration: BoxDecoration(
                              ...
                              boxShadow: const [BoxShadow(color: ThemeProvider.greyColor, blurRadius: 5.0)],
                            ),
                            child: Column(
                              children: [
                                        ...
                                        children: [
                                          ...
                                          Expanded(
                                            child: Column(
                                              crossAxisAlignment: CrossAxisAlignment.start,
                                              children: [
                                                Text('${value.salonOrderInfo.salonInfo!.name}', overflow: TextOverflow.ellipsis, style: const TextStyle(fontFamily: 'bold', fontSize: 14)),
                                                Row(
                                                  children: [
                                                    Expanded(
                                                      child: Text(value.fullAddres.toString(), overflow: TextOverflow.ellipsis, maxLines: 2, style: const TextStyle(fontSize: 11, color: ThemeProvider.blackColor)),
                                                    ),
                                                  ],
                                                ),
                                              ],
                                        ...
                                        children: [
                                          ClipRRect(
                                            ...
                                            child: SizedBox.fromSize(
                                              size: const Size.fromRadius(30),
                                              child: FadeInImage(
                                                image: NetworkImage('${Environments.apiBaseURL}api/storage/images/${value.salonOrderInfo.ownerInfo!.cover.toString()}'),
                                                placeholder: const AssetImage("assets/images/placeholder.jpeg"),
                                                imageErrorBuilder: (context, error, stackTrace) {
                                ...
                                Row(
                                  ...
                                  children: [
                                    Expanded(child: Text('Order At'.tr, overflow: TextOverflow.ellipsis, style: const TextStyle(color: ThemeProvider.blackColor, fontSize: 14, fontFamily: 'bold'))),
                                    Expanded(
                                      child: Text(
                                        value.createdAt,
                                        overflow: TextOverflow.ellipsis,
                                        textAlign: TextAlign.end,
                                        style: const TextStyle(color: ThemeProvider.blackColor, fontSize: 14, fontFamily: 'bold'),
                                      ),
                                    ),
                                  ],
                                ),
                                Padding(
                                  ...
                                  child: Row(
                                    mainAxisAlignment: MainAxisAlignment.spaceBetween,
                                    children: [Text('Orders'.tr, overflow: TextOverflow.ellipsis, style: const TextStyle(color: ThemeProvider.appColor, fontFamily: 'bold', fontSize: 15))],
                                  ),
                                ),
                                Column(
                                  crossAxisAlignment: CrossAxisAlignment.start,
                                      ...
                                      children: [
                                        RichText(
                                          text: TextSpan(
                                            children: [
                                              TextSpan(
                                                text: value.salonOrderInfo.orders![subIndex].name.toString(),
                                                style: const TextStyle(fontSize: 10, color: ThemeProvider.blackColor, fontFamily: 'regular'),
                                              ),
                                              const TextSpan(text: ' '),
                                              TextSpan(text: 'X'.tr, style: const TextStyle(fontSize: 10, color: ThemeProvider.blackColor, fontFamily: 'regular')),
                                              const TextSpan(text: ' '),
                                              TextSpan(
                                                text: value.salonOrderInfo.orders![subIndex].quantity.toString(),
                                                style: const TextStyle(fontSize: 10, color: ThemeProvider.blackColor, fontFamily: 'regular'),
                                              ),
                                            ],
                                          ),
                                ...
                                Padding(
                                  ...
                                  child: Row(
                                    mainAxisAlignment: MainAxisAlignment.spaceBetween,
                                    children: [Text('Pricing'.tr, overflow: TextOverflow.ellipsis, style: const TextStyle(color: ThemeProvider.appColor, fontFamily: 'bold', fontSize: 15))],
                                  ),
                                ),
                                Column(
                                  children: [
                                    Row(
                                      mainAxisAlignment: MainAxisAlignment.spaceBetween,
                                      children: [
                                        Expanded(child: Text('Discount'.tr, overflow: TextOverflow.ellipsis, style: const TextStyle(color: ThemeProvider.greyColor, fontSize: 15))),
                                        Expanded(
                                          child: Text(
                                    ...
                                    Row(
                                      mainAxisAlignment: MainAxisAlignment.spaceBetween,
                                      children: [
                                        Expanded(child: Text('Wallet Discount'.tr, overflow: TextOverflow.ellipsis, style: const TextStyle(color: ThemeProvider.greyColor, fontSize: 15))),
                                        Expanded(
                                          child: Text(
                                    ...
                                    Row(
                                      mainAxisAlignment: MainAxisAlignment.spaceBetween,
                                      children: [
                                        Expanded(child: Text('Distance Cost'.tr, overflow: TextOverflow.ellipsis, style: const TextStyle(color: ThemeProvider.greyColor, fontSize: 15))),
                                        Expanded(
                                          child: Text(
                                            value.currencySide == 'left' ? value.currencySymbol + value.distanceCost.toString() : value.distanceCost.toString() + value.currencySymbol,
                                            overflow: TextOverflow.ellipsis,
                                            textAlign: TextAlign.end,
                                            style: const TextStyle(color: ThemeProvider.greyColor, fontSize: 15),
                                          ),
                                    ...
                                    Row(
                                      mainAxisAlignment: MainAxisAlignment.spaceBetween,
                                      children: [
                                        Expanded(child: Text('Service Tax'.tr, overflow: TextOverflow.ellipsis, style: const TextStyle(color: ThemeProvider.greyColor, fontSize: 15))),
                                        Expanded(
                                          child: Text(
                                            value.currencySide == 'left' ? value.currencySymbol + value.serviceTax.toString() : value.serviceTax.toString() + value.currencySymbol,
                                            overflow: TextOverflow.ellipsis,
                                            textAlign: TextAlign.end,
                                            style: const TextStyle(color: ThemeProvider.greyColor, fontSize: 15),
                                          ),
                                    ...
                                    Row(
                                      mainAxisAlignment: MainAxisAlignment.spaceBetween,
                                      children: [
                                        Expanded(child: Text('Total'.tr, overflow: TextOverflow.ellipsis, style: const TextStyle(color: ThemeProvider.greyColor, fontSize: 15))),
                                        Expanded(
                                          child: Text(
                                            value.currencySide == 'left' ? value.currencySymbol + value.total.toString() : value.total.toString() + value.currencySymbol,
                                            overflow: TextOverflow.ellipsis,
                                            textAlign: TextAlign.end,
                                            style: const TextStyle(color: ThemeProvider.greyColor, fontSize: 15),
                                          ),
                                ...
                                Padding(
                                  ...
                                  child: Row(
                                    mainAxisAlignment: MainAxisAlignment.spaceBetween,
                                    children: [
                                      Expanded(child: Text('Total Amount'.tr, overflow: TextOverflow.ellipsis, style: const TextStyle(color: ThemeProvider.blackColor, fontSize: 15))),
                                      Expanded(
                                        child: Text(
