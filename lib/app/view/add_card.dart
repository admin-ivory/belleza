                    ...
                    children: [
                      Container(
                        ...
                        child: TextField(
                          ...
                          decoration: InputDecoration(border: InputBorder.none, hintText: 'Email Address'.tr),
                        ),
                      ),
                      Container(
                        margin: const EdgeInsets.only(bottom: 20),
                        ...
                        child: TextField(
                          ...
                          decoration: InputDecoration(border: InputBorder.none, hintText: 'Card Holder Name'.tr),
                        ),
                      ),
                      Container(
                        margin: const EdgeInsets.only(bottom: 20),
                        ...
                        child: TextField(
                          ...
                          decoration: InputDecoration(border: InputBorder.none, hintText: 'Card Number'.tr),
                        ),
                      ),
                      Container(
                        margin: const EdgeInsets.only(bottom: 20),
                        ...
                        child: TextField(
                          ...
                          decoration: InputDecoration(border: InputBorder.none, hintText: 'CVV'.tr),
                        ),
                      ),
                      Container(
                        margin: const EdgeInsets.only(bottom: 20),
                        ...
                        child: TextField(
                          ...
                          decoration: InputDecoration(border: InputBorder.none, hintText: 'MM/YY'.tr),
                        ),
                      ),
                      ElevatedButton(
                        ...
                        child: Text('ADD CARD'.tr, style: const TextStyle(color: ThemeProvider.whiteColor, fontSize: 16)),
                      )
                    ],
                  ),
                ),
