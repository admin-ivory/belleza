  ...
  Widget getLanguages() {
    return PopupMenuButton(
      ...
      child: Padding(
        ...
        child: IconButton(icon: const Icon(Icons.translate), color: ThemeProvider.appColor, tooltip: "Save Todo and Retrun to List".tr, onPressed: () {}),
      ),
    ...
    return GetBuilder<ChooseLocationController>(
      builder: (value) {
        return Scaffold(
          ...
          appBar: AppBar(elevation: 0, automaticallyImplyLeading: false, backgroundColor: ThemeProvider.whiteColor, title: const Row(mainAxisAlignment: MainAxisAlignment.end), actions: <Widget>[getLanguages()]),
            ...
            child: Column(
              ...
              children: [
                ...
                ElevatedButton(
                  ...
                  child: Text('USE CURRENT LOCATION'.tr, style: const TextStyle(color: ThemeProvider.whiteColor, fontSize: 14, letterSpacing: 1.1)),
                ),
                ...
                ElevatedButton(
                  ...
                  child: Text('CHOOSE LOCATION'.tr, style: const TextStyle(color: ThemeProvider.appColor, letterSpacing: 1.1)),
                ),
              ],
            ),
          ),
