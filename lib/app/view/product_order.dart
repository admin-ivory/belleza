                                    ...
                                    children: [
                                      Banner(
                                        ...
                                        child: Container(
                                          ...
                                          child: InkWell(
                                            onTap: () => value.onProductDetail(value.productSalonList[index].id as int),
                                            child: Column(
                                              children: [
                                                Row(
                                                  crossAxisAlignment: CrossAxisAlignment.start,
                                                  children: [
                                                    value.productSalonList[index].type == 'salon'
                                                        ? Padding(
                                                            ...
                                                            child: ClipRRect(
                                                              ...
                                                              child: SizedBox.fromSize(
                                                                ...
                                                                child: FadeInImage(
                                                                  image: NetworkImage('${Environments.apiBaseURL}api/storage/images/${value.productSalonList[index].salonInfo!.cover.toString()}'),
                                                        ...
                                                        : Padding(
                                                            ...
                                                            child: ClipRRect(
                                                              ...
                                                              child: SizedBox.fromSize(
                                                                size: const Size.fromRadius(25),
                                                                child: FadeInImage(
                                                                  image: NetworkImage('${Environments.apiBaseURL}api/storage/images/${value.productSalonList[index].freelancerInfo!.cover.toString()}'),
                                                                  placeholder: const AssetImage("assets/images/placeholder.jpeg"),
                                                                  imageErrorBuilder: (context, error, stackTrace) {
                                                                    return Image.asset('assets/images/notfound.png', fit: BoxFit.cover, height: 25, width: 25);
                                                                  },
                                                    ...
                                                    Expanded(
                                                      child: Column(
                                                        ...
                                                        children: [
                                                          value.productSalonList[index].type == 'salon'
                                                              ? Text(
                                                                  value.productSalonList[index].salonInfo!.name.toString(),
                                                            ...
                                                            children: [
                                                              Expanded(
                                                                child: Text(
                                                                  ...
                                                                  overflow: TextOverflow.ellipsis,
                                                                  maxLines: 2,
                                                                  style: const TextStyle(fontSize: 10, color: ThemeProvider.greyColor),
                                                                ),
                                                              ),
                                                            ],
                                                          ),
                                                          const SizedBox(height: 5),
                                                          Text('${'Order Id #'.tr} ${value.productSalonList[index].id}', style: const TextStyle(fontSize: 10, color: ThemeProvider.greyColor))
                                                        ],
                                                      ),
                                                    ),
                                                  ],
                                                ...
                                                Row(
                                                  mainAxisAlignment: MainAxisAlignment.spaceBetween,
                                                  children: [
                                                    Text('Grand Total : '.tr, style: const TextStyle(fontSize: 12, color: ThemeProvider.blackColor, fontFamily: 'bold')),
                                                    Text(
                                                ...
                                                Row(
                                                  mainAxisAlignment: MainAxisAlignment.spaceBetween,
                                                  children: [
                                                    Text('Order At : '.tr, style: const TextStyle(fontSize: 12, color: ThemeProvider.blackColor, fontFamily: 'bold')),
                                                    Text(value.productSalonList[index].createdAt.toString(), style: const TextStyle(fontSize: 12, color: ThemeProvider.blackColor, fontFamily: 'bold')),
                                                  ],
                                                ),
                                              ],
                                            ),
                            ...
                            : Center(
                                child: Column(
                                  ...
                                  children: [
                                    ...
                                    Text('No New Orders Found!'.tr, style: const TextStyle(fontFamily: 'bold', color: ThemeProvider.appColor)),
                                  ],
                                ),
                              ),
                      ),
                                    ...
                                    children: [
                                      Banner(
                                        ...
                                        child: Container(
                                          ...
                                          child: InkWell(
                                            onTap: () => value.onProductDetail(value.productSalonListOld[index].id as int),
                                            child: Column(
                                              children: [
                                                Row(
                                                  crossAxisAlignment: CrossAxisAlignment.start,
                                                  children: [
                                                    value.productSalonListOld[index].type == 'salon'
                                                        ? Padding(
                                                            padding: const EdgeInsets.only(right: 10),
                                                            child: ClipRRect(
                                                              borderRadius: BorderRadius.circular(5),
                                                              child: SizedBox.fromSize(
                                                                size: const Size.fromRadius(25),
                                                                child: FadeInImage(
                                                                  image: NetworkImage('${Environments.apiBaseURL}api/storage/images/${value.productSalonListOld[index].salonInfo!.cover.toString()}'),
                                                                  placeholder: const AssetImage("assets/images/placeholder.jpeg"),
                                                                  imageErrorBuilder: (context, error, stackTrace) {
                                                                    return Image.asset('assets/images/notfound.png', fit: BoxFit.cover, height: 25, width: 25);
                                                                  },
                                                        ...
                                                        : Padding(
                                                            ...
                                                            child: ClipRRect(
                                                              ...
                                                              child: SizedBox.fromSize(
                                                                size: const Size.fromRadius(25),
                                                                child: FadeInImage(
                                                                  image: NetworkImage('${Environments.apiBaseURL}api/storage/images/${value.productSalonListOld[index].freelancerInfo!.cover.toString()}'),
                                                                  placeholder: const AssetImage("assets/images/placeholder.jpeg"),
                                                                  imageErrorBuilder: (context, error, stackTrace) {
                                                                    return Image.asset('assets/images/notfound.png', fit: BoxFit.cover, height: 25, width: 25);
                                                                  },
                                                    ...
                                                    Expanded(
                                                      child: Column(
                                                        ...
                                                        children: [
                                                          value.productSalonListOld[index].type == 'salon'
                                                              ? Text(
                                                                  value.productSalonListOld[index].salonInfo!.name.toString(),
                                                                  overflow: TextOverflow.ellipsis,
                                                                  style: const TextStyle(fontFamily: 'bold', fontSize: 12, color: ThemeProvider.blackColor),
                                                                )
                                                              : Text(
                                                          ...
                                                          const SizedBox(height: 5),
                                                          Text('${'Order Id #'.tr} ${value.productSalonListOld[index].id}', style: const TextStyle(fontSize: 10, color: ThemeProvider.greyColor))
                                                        ],
                                                      ),
                                                    ),
                                                  ],
                            ...
                            : Center(
                                child: Column(
                                  ...
                                  children: [
                                    Image.asset('assets/images/no-data.png', width: 60, height: 60),
                                    const SizedBox(height: 30),
                                    Text('No Past Orders Found!'.tr, style: const TextStyle(fontFamily: 'bold', color: ThemeProvider.appColor)),
                                  ],
                                ),
                              ),
                      ),
