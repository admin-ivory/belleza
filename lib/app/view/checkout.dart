                ...
                children: [
                  value.savedInCart.services!.isNotEmpty
                      ? Row(
                          ...
                          children: [
                            Text('Total'.tr, style: const TextStyle(fontFamily: 'bold', fontSize: 14)),
                            ...
                            children: [
                              ...
                              Expanded(
                                child: Stack(
                                  ...
                                  children: [
                                    Positioned(right: -15, top: -15, child: IconButton(onPressed: () => value.deleteServiceFromCart(i), icon: const Icon(Icons.delete, color: ThemeProvider.redColor))),
                                    Column(
                                      crossAxisAlignment: CrossAxisAlignment.start,
                                      children: [
                                        Text(value.savedInCart.services![i].name.toString(), overflow: TextOverflow.ellipsis, style: const TextStyle(fontFamily: 'bold', fontSize: 14)),
                            ...
                            children: [
                              ...
                              Expanded(
                                child: Stack(
                                  clipBehavior: Clip.none,
                                  children: [
                                    Positioned(right: -15, top: -15, child: IconButton(onPressed: () => value.deletePackageFromCart(i), icon: const Icon(Icons.delete, color: ThemeProvider.redColor))),
                                    Column(
                                      crossAxisAlignment: CrossAxisAlignment.start,
                                      children: [
                                        Text(value.savedInCart.packages![i].name.toString(), overflow: TextOverflow.ellipsis, style: const TextStyle(fontFamily: 'bold', fontSize: 14)),
                                        Column(
                                          mainAxisAlignment: MainAxisAlignment.start,
                                          crossAxisAlignment: CrossAxisAlignment.start,
                                          children: List.generate(
                                            value.savedInCart.packages![i].services!.length,
                                            (serviceIndex) => Text('* ${value.savedInCart.packages![i].services![serviceIndex].name}',
                                                maxLines: 1, overflow: TextOverflow.ellipsis, style: const TextStyle(color: ThemeProvider.greyColor, fontSize: 12)),
                                          ),
                                        ),
                                        const SizedBox(height: 2),
                                        RichText(
                                        ...
                                        Row(
                                          mainAxisAlignment: MainAxisAlignment.spaceBetween,
                                          children: [
                                            Text('Specialist'.tr, overflow: TextOverflow.ellipsis, style: const TextStyle(color: ThemeProvider.blackColor, fontSize: 12)),
                                            Expanded(
                                              child: Padding(
                                                    ...
                                                    (specialistIndex) => specialistIndex == 0
                                                        ? Positioned(
                                                            child: SizedBox(
                                                              ...
                                                              width: 25,
                                                              child: Container(
                                                                decoration: BoxDecoration(borderRadius: BorderRadius.circular(100), border: Border.all(color: ThemeProvider.whiteColor)),
                                                                child: ClipRRect(
                        ...
                        Padding(
                          ...
                          child: Row(
                            ...
                            children: [
                              ...
                              Text(
                                value.currencySide == 'right' ? '${value.currencySymbol} ${Get.find<ServiceCartController>().totalPrice}' : ' ${Get.find<ServiceCartController>().totalPrice}${value.currencySymbol}',
                              )
                            ],
                          ),
                        ),
                        Padding(
                          ...
                          child: Row(
                            ...
                            children: [
                              ...
                              Text(
                                value.currencySide == 'right' ? '${value.currencySymbol} ${Get.find<ServiceCartController>().orderTax}' : ' ${Get.find<ServiceCartController>().orderTax}${value.currencySymbol}',
                              ),
                            ],
                          ),
                        ),
                        ...
                        Padding(
                          ...
                          child: Row(
                            ...
                            children: [
                              ...
                              Text(
                                value.currencySide == 'right' ? '${value.currencySymbol} ${Get.find<ServiceCartController>().grandTotal}' : ' ${Get.find<ServiceCartController>().grandTotal}${value.currencySymbol}',
                ...
                InkWell(
                  ...
                  child: Container(
                    ...
                    child: Row(
                      ...
                      children: [Text('Select Date & Time'.tr, style: const TextStyle(color: ThemeProvider.whiteColor, fontSize: 17))],
                    ),
                  ),
                ),
              ],
