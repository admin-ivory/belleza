              ...
              children: [
                InkWell(
                  ...
                  child: Container(
                    ...
                    decoration: BoxDecoration(color: ThemeProvider.blackColor.withOpacity(0.8)),
                    child: Row(
                      mainAxisAlignment: MainAxisAlignment.center,
                      children: [
                        const Icon(Icons.sort, color: ThemeProvider.whiteColor),
                        const SizedBox(width: 5),
                        Text('Sort By'.tr, style: const TextStyle(color: ThemeProvider.whiteColor, fontSize: 17)),
                      ],
                    ),
                  ),
                ),
                                      ...
                                      children: [
                                        ClipRRect(
                                          ...
                                          child: SizedBox.fromSize(
                                            ...
                                            child: FadeInImage(
                                              image: NetworkImage('${Environments.apiBaseURL}api/storage/images/${value.productsList[index].cover.toString()}'),
                                        ...
                                        Expanded(
                                          child: Column(
                                            ...
                                            children: [
                                              Text(value.productsList[index].name.toString(), overflow: TextOverflow.ellipsis, style: const TextStyle(fontFamily: 'bold', fontSize: 14)),
                                              Text(
                                              ...
                                              RichText(
                                                text: TextSpan(
                                                  children: [
                                                    ...
                                                    TextSpan(
                                                      text: '    ${value.productsList[index].discount} %',
                                                  ...
                                                  value.productsList[index].quantity == 0
                                                          ...
                                                          children: [
                                                            SizedBox(
                                                              ...
                                                              child: ElevatedButton(
                                                                ...
                                                                style: ElevatedButton.styleFrom(backgroundColor: ThemeProvider.appColor, shape: const StadiumBorder()),
                                                                child: Text('Add'.tr, style: const TextStyle(color: ThemeProvider.whiteColor)),
                                                              ),
                                                            )
                                                          ],
                                                        )
                                                      : Row(
                                                          children: [
                                                            ...
                                                            Text(value.productsList[index].quantity.toString()),
                                                            SizedBox(
                                                              height: 30,
                                                              child: CircleAvatar(
                                                                ...
                                                                child: Center(
                                                                  child: IconButton(
                                                                    onPressed: () => value.updateProductQuantity(index),
