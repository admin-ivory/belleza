      ...
      builder: (value) {
        return Scaffold(
          ...
          appBar: AppBar(
              ...
              title: const Row(mainAxisAlignment: MainAxisAlignment.end),
        ...
        Column(
          children: [
            ...
            Text(
                ...
                textAlign: TextAlign.center,
                style: const TextStyle(
                    color: ThemeProvider.greyColor, fontSize: 15)),
          ],
        ),
      ],
    );
      ...
      children: [
        ...
        Column(
          children: [
            Padding(
              padding: const EdgeInsets.symmetric(vertical: 20),
              child: Text('Attractive Promotions !'.tr,
                  textAlign: TextAlign.center,
                  style: const TextStyle(
                      fontFamily: 'bold',
                      color: ThemeProvider.blackColor,
      ...
      children: [
        ...
        Column(
          children: [
            Padding(
              padding: const EdgeInsets.symmetric(vertical: 20),
              child: Text('Professional Specialist !'.tr,
                  style: const TextStyle(
                      fontFamily: 'bold',
                      color: ThemeProvider.blackColor,
                      fontSize: 17)),
      ...
      children: [
        ...
        Column(
          children: [
            Padding(
              padding: const EdgeInsets.symmetric(vertical: 20),
              child: Text('Get Specialist at your door steps !'.tr,
                  style: const TextStyle(
                      fontFamily: 'bold',
                      color: ThemeProvider.blackColor,
                      fontSize: 17)),
      ...
      children: [
        ...
        Column(
          children: [
            Padding(
              padding: const EdgeInsets.symmetric(vertical: 20),
              child: Text('Buy from trusted professional !'.tr,
                  style: const TextStyle(
                      fontFamily: 'bold',
                      color: ThemeProvider.blackColor,
                      fontSize: 17)),
      ...
      child: Row(
        ...
        children: [
          Padding(
            ...
            child: TextButton(
              onPressed: () => Get.toNamed(AppRouter.chooseLocationRoutes),
              child: Center(
                  child: Text('Skip'.tr,
                      style: const TextStyle(
                          fontFamily: 'bold',
