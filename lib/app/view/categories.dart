                                ...
                                (index) => Column(
                                  ...
                                  child: CachedNetworkImage(
                                    ...
                                    placeholder: (context, url) => Image.asset("assets/images/placeholder.jpeg",
                                        fit: BoxFit.cover),
                                    errorWidget: (context, url, error) => Image.asset('assets/images/notfound.png',
                                            ...
                                            child: Container(
                                              ...
                                              child: Center(
                                                child: Row(
                                                  ...
                                                  children: [
                                                    Text(value.productsList[index].name.toString(), style: const TextStyle(color: ThemeProvider.whiteColor, fontSize: 17)),
                                                    Icon(value.selectedCategory == value.productsList[index].id.toString() ? Icons.keyboard_arrow_down : Icons.keyboard_arrow_up, color: Colors.white),
                                                  ],
                                                ),
                                              ),
                                            ),
